...
// @Success 200 {object} api.Response "invitation link"
// @Router /user/invitation/link/{code} [get]
...
// @Param code path string true "code"
// @Success 200
// @Router /user/invitation/link/{code} [put]
func bindInvitationLink(c *gin.Context) {

	service := marketplace.NewUserInvitationService()
	if err := service.BindInvitationLink(c.Request.Context(), c.GetString("uid"), c.Param("code")); err != nil {
		api.Error(c, err)
		return
	}
