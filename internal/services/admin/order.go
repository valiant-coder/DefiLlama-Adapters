...
func (s *AdminServices) GetOrdersCoinTotal(ctx context.Context, startTime, endTime time.Time) (decimal.Decimal, error) {
	return s.ckhdbRepo.GetOrdersCoinTotal(ctx, startTime, endTime)
}

func (s *AdminServices) GetOrdersCoinQuantity(ctx context.Context, startTime, endTime time.Time) ([]*entity_admin.RespOrdersCoinQuantity, error) {
...
func (s *AdminServices) GetOrdersSymbolQuantity(ctx context.Context, startTime, endTime time.Time) ([]*entity_admin.RespOrdersSymbolQuantity, error) {
...
func (s *AdminServices) GetOrdersFeeTotal(ctx context.Context, startTime, endTime time.Time) (decimal.Decimal, error) {
	return s.ckhdbRepo.GetOrdersFeeTotal(ctx, startTime, endTime)
}

func (s *AdminServices) GetOrdersCoinFee(ctx context.Context, startTime, endTime time.Time) ([]*entity_admin.RespOrdersCoinFee, error) {
...
func (s *AdminServices) GetOrdersSymbolFee(ctx context.Context, startTime, endTime time.Time) ([]*entity_admin.RespOrdersSymbolFee, error) {
